#!/usr/bin/env python3
"""Crop Level L0 mask to the 20 m site-transport sub-region."""
...
from region import DEFAULT_RESOLUTION_CM, REGION_SIZE_CM
...
def crop_l0_to_local_region(
    ...
    *,
    ...
    cropped = costs[:h, :w].astype("float32", copy=True)
